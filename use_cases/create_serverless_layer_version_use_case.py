...
from use_cases.services.update_serverless_layer.update_serverless_layer import (
    UpdateServerlessLayer,
)
...
class CreateServerlessLayerVersionUseCase:
    ...
    def create(
        self, environment: str, serverless_info: Dict, layer_zip_file_name: str
    ) -> None:
        ...
        artifact = Artifact(file_name=file_name, temp_path=layer_zip_file_name)
        ...
        self.__publish_layer_version.publish(bucket, artifact)
